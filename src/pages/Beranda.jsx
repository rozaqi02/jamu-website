...
//             </motion.h1>
//             <motion.p
//               className="text-base md:text-lg text-gray-700 dark:text-gray-300 mb-8 max-w-2xl"
//               variants={itemVariants}
//             >
...
<section className="py-20 px-4 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8">
  <img
